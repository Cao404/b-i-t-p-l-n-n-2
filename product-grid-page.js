// Product Grid Page JavaScript
// Tích hợp với product-list-page.js để dùng chung modal
...
function setupFilters() {
  ...
  // Initial render of category filters and counts
...
// Get product by ID (compatible with both storage keys)
function getProductByIdCompat(id) {
  const products = getAllProductsCompat();
  return products.find(function(p) { return p.id == id; }) || null;
}

// Get all products (compatible with both storage keys)
